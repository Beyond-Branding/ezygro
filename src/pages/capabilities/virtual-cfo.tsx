...
const services = [
  {
    title: "MIS",
    description:
      "MIS is a system for creating structured, timely reports that give insights into a company’s operations and finances. It helps management make informed, data driven decisions.",
    features: [
  ...
  },
  {
    title: "Budgeting",
    description:
      "Budgeting is the process of planning how financial resources will be allocated to meet business objectives. It sets limits and helps control spending.",
    features: [
  ...
  },
  {
    ...
    description:
      "Cash flow management ensures the business has enough liquid funds to meet daily obligations. It focuses on balancing cash inflows and outflows.",
    features: [
  ...
  },
  {
    ...
    description:
      "Compliance reporting involves submitting timely and accurate reports to regulatory bodies. It keeps the business legally sound and avoids penalties.",
    features: [
  ...
  },
  {
    ...
    description:
      "SOPs (Standard Operating Procedures) provide step-by-step instructions for business processes. They enhance consistency, training, and efficiency.",
    features: [
  ...
  },
  {
    ...
    description:
      "Business planning involves setting long term goals and creating strategies to achieve them. It includes research, forecasting, and risk management.",
    features: [
  ...
  },
  {
    ...
    description:
      "Financial marketing presents the company’s financial story in a clear, appealing way to attract investors or partners. It builds confidence in the business’s future.",
    features: [
...
export default function VirtualCFOPage() {
  ...
  const [promiseTextVisible, setPromiseTextVisible] = useState(false); // Create the extended list with clones
        ...
        <div className="relative z-10 min-h-screen max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 pt-16 sm:pt-24 lg:pt-28 pb-8 sm:pb-16">
          ...
          <div className="absolute top-15 left-2 sm:top-20 sm:left-12 lg:top-20 lg:left-20 w-full max-w-xs sm:max-w-lg lg:max-w-2xl lg:w-3/5 pr-4 sm:pr-6 lg:pr-6">
            <div className="overflow-hidden pb-2">
              ...
              >
                Virtual CFO and Business Growth
                <span style={{ color: "#4B1D92" }}>Consultancy</span>
              </h1>
            </div>
            ...
            >
              ...
              >
                Gain strategic direction with our Virtual CFO and Business
                Growth Consultancy services. From financial planning and cash
                flow management to performance insights and growth strategies,
                get
                <br /> expert guidance without the cost of a full time CFO.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <p className="text-gray-800 leading-relaxed">
              ...
              clients to focus on their core strengths while we handle the rest.
              From outsourced CFO services to financial modeling, cash flow
              management, and compliance reporting. We take care of the numbers,
              so you can drive growth without the operational clutter.
            </p>
            <div className="mt-4 font-semibold text-black flex items-center cursor-pointer"></div>
          </div>
        </div>
      </section>
            ...
            >
              {extendedServices.map((service, index) => (
                <div
                  key={index}
                  style={{
                    width: `calc(100% / ${extendedServices.length})`,
                    padding: "0 1rem",
                  }}
                >
                    ...
                    <ul className="space-y-4 flex-grow">
                      {service.features.map((feature, fIndex) => (
                        <li key={fIndex} className="flex items-start">
                          <span className="text-purple-900 mr-3 mt-1 flex-shrink-0">
                            ■
                          </span>
