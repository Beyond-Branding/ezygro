...
const terms = `
Welcome to Ezygro.in. This website is owned and operated by EZYGRO financial services and having its registered office at 01, 1st floor, A Wing, Neelyog Samruddhi, Khot Kua Road, Dhanjiwadi, Malad East, Mumbai 400097, Maharashtra, India. You must understand and agree to accept and adhere to the following terms of service as stated in this policy hereafter referred to as ‘User Agreement’, along with the terms and conditions as stated in our Privacy Policy, by visiting our website and accessing the information, resources, services, products, and tools we provide.
...
export default function TermsOfUseModal({
  ...
  const replaced = terms.replace(
    ...
    '<a href="' +
      privacyUrl +
      '" class="text-purple-900 underline hover:text-purple-900">click here</a>'
  );
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60">
      <div className="bg-black text-white rounded-lg shadow-lg w-full max-w-xl p-4 sm:p-6 relative animate-fadeIn max-h-[80vh] overflow-y-auto custom-scrollbar">
        ...
        <div className="mb-6 flex flex-col items-start">
          <span className="h-8 mb-2 text-lg font-semibold tracking-wide text-white drop-shadow-lg">
            EZYGRO
          </span>
