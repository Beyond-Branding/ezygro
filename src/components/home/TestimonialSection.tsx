...
const TestimonialSection = () => {
  ...
  const testimonials = [
    {
      quote:
        "Working with them was a game-changer. Their expertise and dedication are unparalleled.",
      author: "Jane Doe",
    ...
    {
      quote:
        "The results exceeded our expectations. We saw a 200% increase in engagement within months.",
      author: "John Smith",
    ...
    {
      quote:
        "A truly collaborative partner. They listened to our needs and delivered a flawless product.",
      author: "Emily White",
    ...
    {
      quote:
        "Their platform streamlined our entire workflow, saving us countless hours and resources.",
      author: "Michael Brown",
      role: "COO, Efficiency Ops",
      image:
        "https://images.pexels.com/photos/846741/pexels-photo-846741.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    },
    {
      quote:
        "Professional, responsive, and incredibly talented. I highly recommend their services.",
      author: "Sarah Green",
    ...
    {
      quote:
        "They have a deep understanding of the market and provided invaluable strategic insights.",
      author: "David Chen",
      role: "Lead Strategist, Visionary Ltd.",
      image:
        ...
        <div className="relative h-[22rem] sm:h-80 lg:h-96">
          {testimonials.map((item, index) => {
            const offset =
              ...
              testimonials.length;
            const displayIndex = offset < 3 ? offset : -1;
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  <p className="text-lg sm:text-xl lg:text-2xl font-medium text-white italic">
                    &quot;{item.quote}&quot;
                  </p>
                </div>
