...
export default function EzygroHeroSection() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute top-12 left-1 sm:top-16 sm:left-4 md:top-18 md:left-8 lg:top-20 lg:left-16 xl:left-20 w-full max-w-[95%] sm:max-w-sm md:max-w-lg lg:max-w-2xl xl:max-w-3xl lg:w-3/5 pr-2 sm:pr-4 md:pr-6 lg:pr-8">
          <div className="space-y-1 sm:space-y-2 md:space-y-3 lg:space-y-4 text-left w-full max-w-full sm:max-w-md md:max-w-lg lg:max-w-2xl">
            ...
            >
              ...
              >
                In today&apos;s fast paced business environment, success
                requires financial clarity and compliance you can rely on.
                EZYGRO empowers you with smart solutions that drive sustainable
                growth, strategic decision making, and operational excellence
                all at the speed your business demands.
              </p>
            </div>
          </div>
        </div>
