...
export default function VisionPurposeValues() {
      ...
      <div className="flex-1 flex flex-col md:block">
        ...
        <div className="hidden md:block max-w-7xl w-full mx-auto px-4 sm:px-8 lg:px-16">
          <div className="grid md:grid-cols-3 gap-8 items-center min-h-[70vh]">
                    ...
                    style={{
                      ...
                      transform: (() => {
                        ...
                        if (hoveredTab !== null) {
                          ...
                          targetIndex =
                            (activeTab - 1 + content.length) % content.length;
                          isVision = targetIndex === 0;
                        }
                        if (isVision) {
                          return isExpanding
                    ...
                    <img
                      src={(() => {
                        if (hoveredTab !== null) {
                          ...
                          return content[(activeTab + 1) % content.length]
                            .image;
                        } else if (hoveredNavButton === "prev") {
                          return content[
                            (activeTab - 1 + content.length) % content.length
            ...
            <div className="flex items-center justify-start">
              ...
              >
                {currentContent.text ? (
                  <p className="text-xl leading-relaxed whitespace-pre-line max-w-lg">
                    {currentContent.text}
                  </p>
                ) : (
                  <ul className="text-lg space-y-3 max-w-lg"></ul>
                )}
              </div>
            </div>
          </div>
        ...
        <div className="md:hidden flex flex-col h-full">
          ...
          <div className="text-center px-4 mb-6">
            ...
            >
              {currentContent.text ? (
                <p className="text-base leading-relaxed whitespace-pre-line max-w-md mx-auto">
                  {currentContent.text}
                </p>
              ) : (
                <ul className="text-sm space-y-2 max-w-md mx-auto text-left"></ul>
              )}
            </div>
          </div>
          ...
          <div className="px-4 pb-4">
            <div className="w-full bg-gray-700 h-1 rounded-full">
              <div
                ...
                style={{
                  width: `${((activeTab + 1) / content.length) * 100}%`,
                }}
              ></div>
            </div>
          </div>
