...
    <>
      <section className="relative min-h-screen bg-white overflow-hidden -mt-16">
        ...
        {/* Aligned hero content (mirrors InnovativeDashboards) */}
        <div className="relative z-10 min-h-screen max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-16 pt-16 sm:pt-20 md:pt-24 lg:pt-28 pb-8 sm:pb-12 md:pb-16">
          <div className="absolute top-15 left-2 sm:top-16 sm:left-8 md:top-18 md:left-12 lg:top-20 lg:left-20 w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-2xl lg:w-3/5 pr-4 sm:pr-6 md:pr-8 lg:pr-6">
            <div className="overflow-hidden pb-2">
              <h1
                className={`text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold text-gray-900 transition-all duration-1000 ease-out leading-tight ${
...
                <h2 className="text-4xl font-bold text-gray-900">Our <span className="text-purple-900">Services</span></h2>
                <div className="flex gap-3 sm:gap-4 mt-4 sm:mt-0">
                  <button
                    ...
                    className="group relative inline-flex items-center justify-center w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-white/80 backdrop-blur border border-purple-200 shadow-md ring-1 ring-purple-300/40 hover:bg-purple-50 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500"
                    aria-label="Previous slide"
                  >
                    <svg
                      className="w-5 h-5 sm:w-6 sm:h-6 stroke-purple-900 group-hover:stroke-purple-700 transition-colors"
                      viewBox="0 0 24 24"
                      fill="none"
                      strokeWidth="2.2"
                      strokeLinecap="round"
                    ...
                    <span className="pointer-events-none absolute inset-0 rounded-full opacity-0 group-active:opacity-100 group-active:scale-95 bg-purple-200/40 transition" />
                  </button>
                  <button
