// Contact form component using the exact career page styling
            ...
            <form ref={form} onSubmit={sendEmail} className="grid grid-cols-1 md:grid-cols-2 gap-x-6 sm:gap-x-8 gap-y-4 sm:gap-y-6 text-left">
              <FormInput id="enquiryType" name="enquiry_type" label="Type of Enquiry" required>
                <select id="enquiryType" name="enquiry_type" className="block w-full bg-transparent border-0 border-b border-gray-600 focus:ring-0 focus:border-white py-2 text-white">
                  <option className="bg-gray-800">Select Your Service</option>
                  ...
                  <option className="bg-gray-800">General Inquiry</option>
                </select>
              </FormInput>
              <div></div>
              ...
              <FormInput id="company" name="company" label="Company Name" className="md:col-span-2" />
              ...
              <div className="md:col-span-2 space-y-5">
                <div className="relative flex items-start">
                  ...
                  <div className="ml-3 text-sm leading-6">
                    <p className="text-gray-400">By clicking on the submit button, you agree with the <a href="/privacy-notice" className="font-medium text-white hover:underline">Privacy Policy</a>.</p>
                  </div>
                </div>
              </div>
