                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
                    ...
                    <div className="lg:col-span-2">
                        <form ref={form} onSubmit={sendEmail} className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 text-left">
                            ...
                            <FormInput id="organization" name="organization" label="Organization" />
...
export default function App() {
  ...
  const fullAddress = "01, 1st floor, A Wing, Neelyog Samruddhi, Khot Kua Road, Dhanjiwadi, Malad East, Mumbai 400097";
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-16">
            ...
            <div className="w-full h-[50vh] md:h-full min-h-[500px] bg-gray-200 rounded-lg overflow-hidden shadow-lg">
                <MapContainer center={position} zoom={17} scrollWheelZoom={false} className="w-full h-full relative z-0">
                    ...
                    <Popup>
                        <div className="text-left p-2 w-48"> {/* Changed to text-left, added padding, and set a fixed width w-48 (192px) */}
                        <h3 className="font-bold text-base text-gray-800 mb-1">Ezygro</h3>
                        <p className="text-sm text-gray-600 whitespace-normal mb-2">{fullAddress}</p>
                        <a 
                            href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(fullAddress)}`} /* Corrected URL */
                            target="_blank"
