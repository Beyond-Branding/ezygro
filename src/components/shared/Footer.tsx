...
import TermsOfUseModal from '../ui/TermsOfUseModal';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 ml-0 sm:ml-16 md:ml-32 lg:ml-40">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-1 flex items-center" style={{ alignItems: 'flex-start' }}>
              <Image src={logo} alt="Tech Mahindra Logo" className="h-24 w-auto rounded mt-0" style={{ marginTop: '-0.75rem', filter: 'brightness(0) invert(1)' }} />
            </div>
            {/* Our Brand */}
            <div>
